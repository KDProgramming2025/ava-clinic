  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          // Positioning and safe mobile insets
          "bg-background fixed z-50 grid p-6 border rounded-lg shadow-lg duration-200",
          "data-[state=open]:animate-in data-[state=closed]:animate-out",
          "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
          "data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95",
          // Centering behavior: on mobile, keep safe insets top/bottom; on >=sm, true center with translate
          "left-4 right-4 translate-x-0 sm:left-1/2 sm:right-auto sm:translate-x-[-50%]",
          "top-4 bottom-4 translate-y-0 sm:top-1/2 sm:bottom-auto sm:translate-y-[-50%]",
          // Sizing and scroll containment
          "w-auto max-w-[calc(100%-2rem)] sm:max-w-lg gap-4 overflow-y-auto",
          // Use svh for mobile browser chrome, fallback to vh
